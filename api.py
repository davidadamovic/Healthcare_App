...
def get_patients():
    ...
    for element in data:        # for loop som unpackar inhämdad data som kommer som en Dickt 
        id, name, age, gender, dep_id = element  # unpackar listan och får fram alla kolumner i tabellen "patient"
        # kolumnerna ska appendar till attributer fårn Klassen Patient som är en Base Model
